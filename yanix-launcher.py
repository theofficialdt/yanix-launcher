...
LANGUAGES = {
    "en": {
        "welcome": "Welcome to Yanix Launcher",
        "loading": "Loading",
        "play": "Play",
        "github": "GitHub",
        "settings": "Settings",
        ...
        "select_exe": "Select .exe for WINE",
        "support": "Support",
        "discord": "Discord",
        "lang_changed": "Language changed!",
        "exit": "Exit",
        "missing_path": "Uh oh, try extract in home folder",
        "winetricks": "Winetricks",
        "no_internet": "No internet connection. Please check your network and try again.",
        "downloading_data": "Downloading Data File....",
        "extracting_data": "Extracting Files....",
        "download_failed": "Failed to download data.",
        "extract_failed": "Failed to extract data.",
        "download_success": "Data downloaded and extracted successfully!",
        "wineprefix": "Manage Wineprefix",
        "wineprefix_selected": "Wineprefix path saved successfully.",
        "wineprefix_error": "Could not save Wineprefix path.",
        "select_theme": "Select Theme",
        "theme_changed": "Theme changed!",
        "load_custom_theme": "Load Custom Theme",
        "delete_game": "Delete Game",
        "delete_game_confirm": "Are you sure you want to delete the game? This action cannot be undone.",
        "game_deleted_success": "Game deleted successfully!",
        "game_not_found": "Game not found at the installed path.",
        "check_updates": "Check for Updates",
        "update_outdated": "Your launcher is outdated. The application will now be updated and restarted.",
        "update_developer": "You are running a developer build.",
        "update_uptodate": "Your launcher is up to date.",
        "update_error": "Could not check for updates.",
        "advanced_mode": "Advanced Mode",
        "advanced_enabled": "Advanced Mode is Enabled",
        "advanced_disabled": "Advanced Mode is Disabled"
    },
    "es": {
        "welcome": "Bienvenido a Yanix Launcher",
        "loading": "Cargando",
        "play": "Jugar",
        "github": "GitHub",
        ...
        "select_exe": "Seleccionar .exe para WINE",
        "support": "Soporte",
        "discord": "Discord",
        "lang_changed": "¡Idioma cambiado!",
        "exit": "Salir",
        "missing_path": "Uh oh, intenta extraerlo en tu carpeta personal",
        "winetricks": "Winetricks",
        "no_internet": "Sin conexión de internet. Por favor, revisa tu red e inténtalo de nuevo.",
        "downloading_data": "Descargando archivo de datos....",
        "extracting_data": "Extrayendo archivos....",
        "download_failed": "Fallo al descargar datos.",
        "extract_failed": "Fallo al extraer datos.",
        "download_success": "Datos descargados y extraídos exitosamente!",
        "wineprefix": "Administrar Wineprefix",
        "wineprefix_selected": "Ruta de Wineprefix guardada exitosamente.",
        "wineprefix_error": "No se pudo guardar la ruta de Wineprefix.",
        "select_theme": "Seleccionar Tema",
        "theme_changed": "¡Tema cambiado!",
        "load_custom_theme": "Cargar Tema Personalizado",
        "delete_game": "Eliminar Juego",
        "delete_game_confirm": "¿Estás seguro de que quieres eliminar el juego? Esta acción no se puede deshacer.",
        "game_deleted_success": "Juego eliminado exitosamente!",
        "game_not_found": "Juego no encontrado en la ruta instalada.",
        "check_updates": "Buscar actualizaciones",
        "update_outdated": "Tu lanzador está desactualizado. La aplicación se actualizará y se reiniciará ahora.",
        "update_developer": "Estás ejecutando una versión de desarrollador.",
        "update_uptodate": "Tu lanzador está actualizado.",
        "update_error": "No se pudieron buscar actualizaciones.",
        "advanced_mode": "Modo Avanzado",
        "advanced_enabled": "Modo Avanzado Activado",
        "advanced_disabled": "Modo Avanzado Desactivado"
    },
    "pt": {
        "welcome": "Bem-vindo ao Yanix Launcher",
        "loading": "Carregando",
        "play": "Jogar",
        "github": "GitHub",
        ...
        "select_exe": "Selecionar .exe para WINE",
        "support": "Suporte",
        "discord": "Discord",
        "lang_changed": "Idioma alterado!",
        "exit": "Sair",
        "missing_path": "Uh oh... tente extrai-lo na sua pasta pessoal.",
        "winetricks": "Winetricks",
        "no_internet": "Sem conexão com a internet. Por favor, verifique sua rede e tente novamente.",
        "downloading_data": "Baixando arquivo de dados....",
        "extracting_data": "Extraindo arquivos....",
        "download_failed": "Falha ao baixar dados.",
        "extract_failed": "Falha ao extrair dados.",
        "download_success": "Dados baixados e extraídos com sucesso!",
        "wineprefix": "Gerenciar Wineprefix",
        "wineprefix_selected": "Caminho do Wineprefix salvo com sucesso!",
        "wineprefix_error": "Não foi possível salvar o caminho do Wineprefix.",
        "select_theme": "Selecionar Tema",
        "theme_changed": "Tema alterado!",
        "load_custom_theme": "Carregar Tema Personalizado",
        "delete_game": "Excluir Jogo",
        "delete_game_confirm": "Tem certeza de que deseja excluir o jogo? Esta ação não pode ser desfeita.",
        "game_deleted_success": "Jogo excluído com sucesso!",
        "game_not_found": "Jogo não encontrado no caminho de instalação.",
        "check_updates": "Verificar atualizações",
        "update_outdated": "Seu launcher está desatualizado. O aplicativo será atualizado e reiniciado agora.",
        "update_developer": "Você está executando uma versão de desenvolvedor.",
        "update_uptodate": "Seu launcher está atualizado.",
        "update_error": "Não foi possível verificar atualizações.",
        "advanced_mode": "Modo Avançado",
        "advanced_enabled": "Modo Avançado Habilitado",
        "advanced_disabled": "Modo Avançado Desabilitado"
    },
    "ru": {
        "welcome": "Добро пожаловать в Yanix Launcher",
        "loading": "Загрузка",
        "play": "Играть",
        "github": "GitHub",
        "settings": "Настройки",
        ...
        "select_exe": "Выбрать .exe для WINE",
        "support": "Поддержка",
        "discord": "Discord",
        "lang_changed": "Язык изменен!",
        "exit": "Выход",
        "missing_path": "Упс, попробуйте извлечь в домашнюю папку",
        "winetricks": "Управление Winetricks",
        "no_internet": "Нет подключения к интернету. Пожалуйста, проверьте свою сеть и повторите попытку.",
        "downloading_data": "Загрузка файла данных....",
        "extracting_data": "Извлечение файлов....",
        "download_failed": "Не удалось загрузить данные.",
        "extract_failed": "Не удалось извлечь данные.",
        "download_success": "Данные успешно загружены и извлечены!",
        "wineprefix": "Управление Wineprefix",
        "wineprefix_selected": "Путь Wineprefix успешно сохранен.",
        "wineprefix_error": "Не удалось сохранить путь Wineprefix.",
        "select_theme": "Выбрать тему",
        "theme_changed": "Тема изменена!",
        "load_custom_theme": "Загрузить пользовательскую тему",
        "delete_game": "Удалить игру",
        "delete_game_confirm": "Вы уверены, что хотите удалить игру? Это действие необратимо.",
        "game_deleted_success": "Игра успешно удалена!",
        "game_not_found": "Игра не найдена по установленному пути.",
        "check_updates": "Проверить обновления",
        "update_outdated": "Ваш лаунчер устарел. Приложение будет обновлено и перезапущено сейчас.",
        "update_developer": "Вы используете сборку для разработчиков.",
        "update_uptodate": "Ваш лаунчер обновлен.",
        "update_error": "Не удалось проверить обновления.",
        "advanced_mode": "Расширенный режим",
        "advanced_enabled": "Расширенный режим включен",
        "advanced_disabled": "Расширенный режим выключен"
    },
    "ja": {
        "welcome": "Yanix Launcherへようこそ",
        "loading": "読み込み中",
        "play": "プレイ",
        "github": "GitHub",
        "settings": "設定",
        ...
        "select_exe": "WINE用の.exeを選択",
        "support": "サポート",
        "discord": "Discord",
        "lang_changed": "言語が変更されました！",
        "exit": "終了",
        "missing_path": "うーん、ホームフォルダに抽出してみてください",
        "winetricks": "Winetricks",
        "no_internet": "インターネット接続がありません。ネットワークを確認してもう一度お試しください。",
        "downloading_data": "データファイルをダウンロード中....",
        "extracting_data": "ファイルを展開中....",
        "download_failed": "データのダウンロードに失敗しました。",
        "extract_failed": "データの抽出に失敗しました。",
        "download_success": "データが正常にダウンロードされ、抽出されました！",
        "wineprefix": "Wineprefixを管理",
        "wineprefix_selected": "Wineprefixパスが正常に保存されました。",
        "wineprefix_error": "Wineprefixパスを保存できませんでした。",
        "select_theme": "テーマを選択",
        "theme_changed": "テーマが変更されました！",
        "load_custom_theme": "カスタムテーマをロード",
        "delete_game": "ゲームを削除",
        "delete_game_confirm": "ゲームを削除してもよろしいですか？この操作は元に戻せません。",
        "game_deleted_success": "ゲームが正常に削除されました！",
        "game_not_found": "インストールパスにゲームが見つかりません。",
        "check_updates": "アップデートを確認",
        "update_outdated": "ランチャーが古くなっています。アプリケーションは更新され、再起動されます。",
        "update_developer": "開発者ビルドを実行しています。",
        "update_uptodate": "ランチャーは最新です。",
        "update_error": "アップデートを確認できませんでした。",
        "advanced_mode": "アドバンスモード",
        "advanced_enabled": "アドバンスモードが有効です",
        "advanced_disabled": "アドバンスモードが無効です"
    },
    "ko": {
        "welcome": "Yanix Launcher에 오신 것을 환영합니다",
        "loading": "로딩 중",
        "play": "플레이",
        "github": "GitHub",
        "settings": "설정",
        ...
        "select_exe": "WINE용 .exe 선택",
        "support": "지원",
        "discord": "Discord",
        "lang_changed": "언어가 변경되었습니다!",
        "exit": "종료",
        "missing_path": "오류, 홈 폴더에 압축을 풀어 보세요",
        "winetricks": "Winetricks",
        "no_internet": "인터넷 연결이 없습니다. 네트워크를 확인하고 다시 시도하십시오.",
        "downloading_data": "데이터 파일 다운로드 중....",
        "extracting_data": "파일 압축 해제 중....",
        "download_failed": "데이터 다운로드 실패.",
        "extract_failed": "데이터 추출 실패.",
        "download_success": "데이터가 성공적으로 다운로드 및 추출되었습니다!",
        "wineprefix": "Wineprefix 관리",
        "wineprefix_selected": "Wineprefix 경로가 성공적으로 저장되었습니다.",
        "wineprefix_error": "Wineprefix 경로를 저장할 수 없습니다.",
        "select_theme": "테마 선택",
        "theme_changed": "테마가 변경되었습니다!",
        "load_custom_theme": "사용자 지정 테마 로드",
        "delete_game": "게임 삭제",
        "delete_game_confirm": "게임을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
        "game_deleted_success": "게임이 성공적으로 삭제되었습니다!",
        "game_not_found": "설치된 경로에서 게임을 찾을 수 없습니다.",
        "check_updates": "업데이트 확인",
        "update_outdated": "런처가 오래되었습니다. 애플리케이션이 업데이트되고 지금 다시 시작됩니다.",
        "update_developer": "개발자 빌드를 실행 중입니다.",
        "update_uptodate": "런처가 최신입니다.",
        "update_error": "업데이트를 확인할 수 없습니다.",
        "advanced_mode": "고급 모드",
        "advanced_enabled": "고급 모드가 활성화되었습니다",
        "advanced_disabled": "고급 모드가 비활성화되었습니다"
    },
    "ndk": {
        "welcome": "niko Niko-Launcher!",
        "loading": "You Activated the Nikodorito Easter-egg!",
        "play": "Niko",
        "github": "GitHub",
        "settings": "Meow",
        "download": "Dalad Gaem",
        "select_language": "niko to to ni",
        "select_exe": "niko to to ni WINE",
        "support": "niko to to ni",
        "discord": "Discorda",
        "lang_changed": "Niko DOrito! Niko dorito kimegasu",
        "exit": "nikotorito",
        "missing_path": "Uh oh, try extract in home foldar, stupid",
        "winetricks": "manage the fucking winetricks",
        "no_internet": "no internet. check your network, stupid.",
        "downloading_data": "downloading daka file....",
        "extracting_data": "extracting files....",
        "download_failed": "fail to download daka.",
        "extract_failed": "fail to extract daka.",
        "download_success": "daka downloaded and extracted successfully!",
        "wineprefix": "manage the fucking wineprefix",
        "wineprefix_selected": "wineprefix path saved successfully, stupid.",
        "wineprefix_error": "could not save wineprefix path, stupid.",
        "select_theme": "niko select theme",
        "theme_changed": "niko theme changed!",
        "load_custom_theme": "load custom niko theme",
        "delete_game": "delete game, stupid",
        "delete_game_confirm": "you sure you wanna delete the game, stupid? can't undo.",
        "game_deleted_success": "game deleted, stupid!",
        "game_not_found": "game not found, stupid.",
        ...
        "update_developer": "you are running a developer build, stupid.",
        "update_uptodate": "your launcher is up to date, stupid.",
        "update_error": "could not check for updates, stupid.",
        "advanced_mode": "Niko Advanced Mode",
        "advanced_enabled": "Advanced Mode is Niko Enabled",
        "advanced_disabled": "Advanced Mode is Niko Disabled"
    }
}
